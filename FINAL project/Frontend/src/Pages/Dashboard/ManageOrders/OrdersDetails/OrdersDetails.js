                                             ...
                                             <div className="card">
                                                <div className="card-body">
                                                   <div className="d-flex flex-column align-items-center text-center">
                                                      ...
                                                      <div className="mt-3">
                                                         <h4>Order ID:{managerDetails.OId}</h4>
                                                         <p className="text-secondary mb-1">Order Status:{managerDetails.OrderStatus}</p>
                                                         <p className="text-muted font-size-sm">Order Date{managerDetails.OrderDate}</p>
                                                ...
                                                <div className="card-body">
                                                   <div className="row">
                                                      <div className="col-sm-3">
                                                         <h6 className="mb-0">Order Pay Method</h6>
                                                      </div>
                                                      <div className="col-sm-9 text-secondary">
                                                         {managerDetails.OrderPayMethod}
                                                      </div>
                                                   </div>
                                                   <hr />
                                                   <div className="row">
